...
![Untitled](readmeData/Untitled%202.png)

→ 위와 같은 예시 .py 파일을 만들고 읽기가 가능한지 Process 클래스를 사용하여 테스트 해봄

![Untitled](readmeData/Untitled%203.png)

![Untitled](readmeData/Untitled%204.png)

→ 필요한 .py 아웃풋을 C#으로 받을 수 있는 것을 확인

1. **배열 형식의 중첩된 json 파일 읽기 가능 확인**

![Untitled](readmeData/Untitled%205.png)

→ 위와 같이 key 값이 ip인 형태의 json 형식에서 value 값이 배열 형태로 된 파일을 읽는 방법을 찾아봄

![Untitled](readmeData/Untitled%206.png)

→ 비슷한 형식의 .json 파일을 만들고 읽기가 가능한지 실행해 봄

![Untitled](readmeData/Untitled%207.png)

→ json 변수의 형태를 jObject가 아닌 jArray로 선언하고 코드를 작성하여 실행

![Untitled](readmeData/Untitled%208.png)

→ 값이 정상적으로 들어가는 것을 확인

1. **GUI 와샥와샥 Winform 프로토타입 구성**

![Untitled](readmeData/Untitled%209.png)

1. **Python에서 C#에 전달할 데이터 추출 테스트**

![Untitled](readmeData/Untitled%2010.png)
...
1. **특정 패킷을 선택하여 파일로 저장하는 기능 구현(C# Winform)**
    ...
    **1-1. ListView 패킷 정보 저장** 
    ...
    ![Untitled](readmeData/Untitled%2013.png)

    [ListView.json](readmeData/ListView.json)

    **1-2. Follow Stream 저장** 

    ![Untitled](readmeData/Untitled%2014.png)

    [FollowStream.json](readmeData/FollowStream.json)

    **1-3. Raw Packet 저장** 

    ![Untitled](readmeData/Untitled%2015.png)

    [RawPacket.json](readmeData/RawPacket.json)

    **1-4. Json View 저장** 

    ![Untitled](readmeData/Untitled%2016.png)

    [JsonView.json](readmeData/JsonView.json)

1. **Python에서 각 패킷의 Raw Packet과 Json View를 C#에 넘겨주는 코드 추가**

![Untitled](readmeData/Untitled%2017.png)
...
1. **GUI에서 Raw Packet과 Json View를 보여줄 수 있도록 함**
    ...
    ![Untitled](readmeData/Untitled%2018.png)

    ![Untitled](readmeData/Untitled%2019.png)

    Raw Packet 혹은 Json View 버튼을 눌렀을 때 새로운 Packet Details Form을 Modaless 방식으로 표시한다.

2. F**ollow Stream 출력 부분 구현**

    ![Untitled](readmeData/Untitled%2020.png)
...
1. **예외처리**
    ...
    ![Untitled](readmeData/Untitled%2021.png)
    ...
    ![Untitled](readmeData/Untitled%2022.png)
...
1. **필터링 기능**
    ...
    ![Untitled](readmeData/Untitled%2027.png)

    ![Untitled](readmeData/Untitled%2028.png)

    CheckedChanged 이벤트를 등록하여 Checked 상태 변경시 해당 열 숨기기 기능

    ![Untitled](readmeData/Untitled%2029.png)

2. **GUI 개선**

    **Hex View 개선**

    ![Untitled](readmeData/Untitled%2030.png)
...
![Untitled](readmeData/Untitled%2032.png)

모든 패킷을 전부 읽었을 때 Complete가 출력되고 ProgressBar가 꽉 채워짐.

![Untitled](readmeData/Untitled%2033.png)
...
![Untitled](readmeData/Untitled%2034.png)
